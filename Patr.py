...
app_ = Label(frameCima,text="Calculadora de patrimônio líquido",compound=LEFT, padx=5, relief=FLAT, anchor=NW, font=('Ivy 12'),bg=co1, fg=co4 )
app_.place(x=50, y=0)
...
#  Imóveis
l_imoveis = Label(frameAtivos, text="Imóveis", height=1,anchor=E, font=('Verdana 9 '), bg=co9, fg=co0)
...
# Veículos
l_veiculos = Label(frameAtivos, text="Veículos", height=1,anchor=E, font=('Verdana 9 '), bg=co9, fg=co0)
